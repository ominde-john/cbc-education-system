...
```bash
curl -X GET "http://localhost:3000/api/v1/academic-terms/school/1" \
...
bash
# Filter by year
curl -X GET "http://localhost:3000/api/v1/academic-terms/school/1?year=2024" \
  -H "Authorization: Bearer YOUR_AUTH_TOKEN"

# Filter by current
curl -X GET "http://localhost:3000/api/v1/academic-terms/school/1?is_current=true" \
  -H "Authorization: Bearer YOUR_AUTH_TOKEN"

# Filter by active status
curl -X GET "http://localhost:3000/api/v1/academic-terms/school/1?is_active=true" \
  -H "Authorization: Bearer YOUR_AUTH_TOKEN"
```

### 2. GET Current Term
```bash
curl -X GET "http://localhost:3000/api/v1/academic-terms/school/1/current" \
  -H "Authorization: Bearer YOUR_AUTH_TOKEN"
```
...
```
bash
curl -X GET "http://localhost:3000/api/v1/academic-terms/1" \
  -H "Authorization: Bearer YOUR_AUTH_TOKEN"
```
...
```
bash
curl -X POST "http://localhost:3000/api/v1/academic-terms" \
  -H "Authorization: Bearer YOUR_AUTH_TOKEN" \
...
```
bash
curl -X PUT "http://localhost:3000/api/v1/academic-terms/1" \
  -H "Authorization: Bearer YOUR_AUTH_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
...
```
bash
curl -X PATCH "http://localhost:3000/api/v1/academic-terms/1/set-current" \
  -H "Authorization: Bearer YOUR_AUTH_TOKEN"
```
...
```
bash
curl -X PATCH "http://localhost:3000/api/v1/academic-terms/1/toggle-status" \
  -H "Authorization: Bearer YOUR_AUTH_TOKEN"
```
...
curl -X DELETE "http://localhost:3000/api/v1/academic-terms/1" \
  -H "Authorization: Bearer YOUR_AUTH_TOKEN"
```
...
```
javascript
const BASE_URL = 'http://localhost:3000/api/v1/academic-terms';
