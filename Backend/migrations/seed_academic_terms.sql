-- Dummy data for academic_terms table
-- This SQL can be run to insert sample academic terms for testing

-- First, make sure the academic_terms table exists
-- If not, create it with this schema:
