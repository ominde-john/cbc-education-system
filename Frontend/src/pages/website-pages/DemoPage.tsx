            ...
            {platformFeatures.map((feature, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-slate-800 rounded-xl border border-slate-200 p-6 hover:shadow-md transition-shadow"
                >
                  <div className="w-10 h-10 bg-blue-900/30 rounded-lg flex items-center justify-center text-blue-600 mb-4">
